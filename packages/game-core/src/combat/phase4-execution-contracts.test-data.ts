...
export const PUBLISHED_SKILL_CONTRACTS: readonly PublishedSkillContract[] = [
  ...
  { id: 'lifebinder.vital-sever', cost: [40, 2], hp: enemy(-10, -5) },
  { id: 'lifebinder.searing-bloom', cost: [55, 3], hp: enemies(-7, -3) },

  { id: 'aetherist.arc-bolt', cost: [35, 2], hp: enemy(-9, -4) },
  { id: 'aetherist.mana-burst', cost: [50, 3], hp: enemies(-7, -3) },
  {
  ...
  { id: 'aetherist.channel', cost: [25, 2], mp: actor(8, 4) },
  { id: 'aetherist.mana-shield', cost: [35, 2], applied: { actor: ['guarded'] } },
  { id: 'aetherist.chain-spark', cost: [50, 3], hp: enemies(-8, -4) },
  { id: 'aetherist.overchannel', cost: [65, 4], hp: enemy(-16, -8) },
  ...
  { id: 'essence.lifebinder.verdant-rupture', cost: [55, 3, 60], hp: enemy(-18, -9) },
  { id: 'essence.aetherist.aether-nova', cost: [60, 4, 65], hp: enemies(-14, -7) },
  ...
  { id: 'essence.edgedancer.sevenfold-cut', cost: [65, 0, 70], hp: enemy(-28, -14) },
  {
