...
export function AiBattlePvpVisualSync({ playerName }: { playerName: string }) {
  useEffect(() => {
    ...
    // AI parity hooks only depend on the mounted battle. Watching document.body made unrelated
    // portals and shell updates rescan the entire battle and multiplied work during action commits.
