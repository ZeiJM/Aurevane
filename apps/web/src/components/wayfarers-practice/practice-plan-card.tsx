  ...
  return (
    ...
    >
      ...
      <p className={styles.note}>
        ...
        pages, Online Users, and social/chat surfaces remain available. If you stop early, the server
        awards the XP earned for the completed fraction of the training time; the unfinished fraction
        earns nothing.
      </p>
