    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Character Level also matures every Adventure Stat across Levels 1–100. In particular, Level contributes to both Physical Power and Mystic Power so every class retains a meaningful offensive baseline even when Might or Intellect is not a Primary focus.',
          'Basic Attack reads Physical Power. Damaging regular Skills use Physical Power unless authored as mystic, in which case they use Mystic Power. The current Skill-wide Power contribution is 25% of the matching Power rating, distributed across multi-hit direct-damage effects before defense and repeat-use falloff.',
