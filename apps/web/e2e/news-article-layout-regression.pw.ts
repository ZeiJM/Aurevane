...
test('News article preview uses the approved editorial composition on desktop', async ({
  page,
}, info) => {
...
test('News article preview stays a natural single-column read on mobile', async ({ page }, info) => {
