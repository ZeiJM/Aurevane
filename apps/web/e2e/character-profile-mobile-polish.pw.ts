...
test(
  'mobile Character Profile keeps loadout controls centered and portrait optically balanced',
  async ({ page }, testInfo) => {
    test.skip(
    ...
    const portraitTransform = await portrait.evaluate(
