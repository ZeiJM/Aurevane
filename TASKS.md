...
2026-09-23 continuation adds a distinct encounterable Crown Road sector between Aureth Crown and Verdant Expanse, original map/panorama art, filtered exit controls and an authoritative travel-time estimate. The actual sector coordinate drives the globe marker. Coastal Road continues that path from Verdant Expanse to Hollow Coast with distinct cliffside/shore terrain, surf and its own panorama. Six other regional links retain timed transitions; this remains an incremental authored-world candidate, not full Phase-5 completion.
